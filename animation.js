gsap.to(".hat", {x:900, y:290, ease: "bounce.out", rotation: 360, duration: 5})
gsap.from(".hat", {opacity: 0, duration: 4, delay: 2})



particlesJS("particles-js", {"particles":{"number":{"value":400,"density":{"enable":true,"value_area":800}},
...
"move":{"enable":true,"speed":3.333805622463184,"direction":"bottom","random":true,
...
"onclick":{"enable":true,"mode":"repulse"},"resize":true},"modes":{"grab":{"distance":400,"line_linked":{"opacity":0.5}},
"bubble":{"distance":400,"size":4,"duration":0.3,"opacity":1,"speed":3},"repulse":{"distance":200,"duration":0.4},
